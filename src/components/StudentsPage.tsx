    ...
    <div>
      ...
      {showForm && (
        <div className="bg-white rounded-xl shadow-sm p-5 mb-4 border-l-4 border-blue-500">
          <h3 className="font-semibold text-gray-800 mb-3">New student</h3>
        ...
        {filtered.length === 0 ? (
          ...
          <table className="w-full">
            <thead className="bg-gray-50">
              <tr>
                <th className="px-5 py-3 text-left text-sm font-semibold text-gray-600">First and last name</th>
                <th className="px-5 py-3 text-left text-sm font-semibold text-gray-600">Class</th>
                <th className="px-5 py-3 text-left text-sm font-semibold text-gray-600">Parents</th>
