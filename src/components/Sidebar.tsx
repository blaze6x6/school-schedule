...
const adminMenuItems: { page: Page; label: string; icon: React.ReactNode }[] = [
  ...
  { page: 'class-schedule', label: 'Class schedule', icon: <Calendar className="w-5 h-5" /> },
  { page: 'events', label: 'Events', icon: <CalendarCheck className="w-5 h-5" /> },
  { page: 'notes', label: 'Notes', icon: <StickyNote className="w-5 h-5" /> },
  { page: 'grades', label: 'Grades', icon: <Award className="w-5 h-5" /> },
  { page: 'students', label: 'Students', icon: <GraduationCap className="w-5 h-5" /> },
  { page: 'subjects', label: 'Subjects', icon: <BookOpen className="w-5 h-5" /> },
  { page: 'classes', label: 'Classes', icon: <School className="w-5 h-5" /> },
  { page: 'users', label: 'Users', icon: <UserCog className="w-5 h-5" /> },
  { page: 'parents', label: 'Parents & Children', icon: <Link className="w-5 h-5" /> },
  { page: 'periods', label: 'School periods', icon: <Clock className="w-5 h-5" /> },
  { page: 'school-year', label: 'School year', icon: <CalendarDays className="w-5 h-5" /> },
  ...
  return (
    <>
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-40 bg-blue-800 flex items-center h-14 px-4 shadow-lg">
        ...
        <span className="ml-3 text-white font-semibold text-lg">School Schedule</span>
      </div>
