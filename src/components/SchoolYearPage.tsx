...
export default function SchoolYearPage() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-gray-800 mb-6">School year</h1>
      ...
      <div className="bg-white rounded-xl shadow-sm p-6 max-w-lg">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h2 className="font-semibold text-gray-800">Time range</h2>
            <p className="text-sm text-gray-500">Determine the start and end of the school year</p>
          </div>
        </div>

        <div className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Start of the school year</label>
            <input
              type="date"
              value={startDate}
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">End of the school year</label>
            <input
              type="date"
              value={endDate}
