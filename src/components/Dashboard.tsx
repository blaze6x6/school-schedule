  ...
  if (children.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-20 bg-white rounded-xl shadow-sm">
        ...
        <h2 className="text-xl font-bold text-gray-700 mb-2">No related children</h2>
        <p className="text-gray-500 text-center max-w-md">
          {user.role === 'admin' 
            ? 'Link your account to your children in the "Parents & Children" section to view their schedules.'
            : 'Contact your administrator to link your account to your child.'}
        </p>
      </div>
    );
  }
          ...
          {!notesLoading && recentNotes.length > 0 && (
            <div className="mb-4 p-3 bg-yellow-50 rounded-lg border border-yellow-200">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm font-semibold text-yellow-800">Latest notes</span>
              </div>
