    ...
    <div>
      ...
      {!selectedClassId ? (
        <div className="bg-white rounded-xl shadow-sm p-10 text-center text-gray-500">
          ...
          <p>Select a class to edit the schedule.</p>
        </div>
      ) : (
        <>
          ...
          <div className="bg-white rounded-xl shadow-sm overflow-hidden mb-6">
            <div className="p-4 bg-blue-50 border-b border-blue-100">
              <p className="text-sm text-blue-700 font-medium">
                💡 Click on a cell to add or edit subject. Breaks are marked with an icon and are not clickable.
              </p>
            </div>
          ...
          <h3 className="text-lg font-semibold text-gray-800 mb-3 mt-6">Preview with date calendar</h3>
          <ScheduleView
            key={refreshKey}
            classId={selectedClassId}
  ...
  return (
    <div className="mt-6">
      <div className="flex items-center justify-between mb-3">
        <h3 className="text-lg font-semibold text-gray-800">🌤️ Afternoon activities</h3>
        <button
      ...
      {entries.length === 0 ? (
        <div className="bg-white rounded-xl shadow-sm p-6 text-center text-gray-400 text-sm">
          There are no afternoon activities. Click "Add" to enter.
        </div>
      ) : (
