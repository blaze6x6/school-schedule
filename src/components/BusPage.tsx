  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6 flex-wrap gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-800">School bus timetable</h1>
          <p className="text-gray-500 text-sm mt-1">The same every school day</p>
        </div>
        <button
      ...
      {showForm && (
        <div className="bg-white rounded-xl shadow-sm p-5 mb-4 border-l-4 border-blue-500">
          <h3 className="font-semibold text-gray-800 mb-3">New route</h3>
