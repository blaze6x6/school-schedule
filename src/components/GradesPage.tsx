    ...
    <div>
      <div className="flex items-center justify-between mb-6 flex-wrap gap-4">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">Student grades by subject</p>
        </div>
      </div>
      {/* Student selector */}
      <div className="bg-white rounded-xl shadow-sm p-4 mb-6">
        <label className="block text-sm font-medium text-gray-600 mb-2">Select a student</label>
        <select
        ...
        <>
          ...
          <div className="flex items-center justify-between mb-4 flex-wrap gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Class: {getClassName(selectedStudent?.classId || '')}</p>
              </div>
            </div>
            {isAdmin && (
              <button
              ...
              >
                <Plus className="w-4 h-4" /> Add a grade
              </button>
            )}
          </div>
          {/* New grade form */}
          {showForm && isAdmin && (
            <div className="bg-white rounded-xl shadow-sm p-5 mb-4 border-l-4 border-purple-500">
              <h3 className="font-semibold text-gray-800 mb-3">New grade</h3>
              ...
              <div className="mt-3">
                ...
                <input
                  ...
                  placeholder="e.g. control task, questioning"
                  className="w-full px-3 py-2 border border-gray-200 rounded-lg outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
                          ...
                          <>
                            ...
                            <td className="px-4 py-3 text-center">
                              <span className={`inline-block px-2 py-0.5 rounded text-xs font-medium ${
                                ...
                                {g.type === 'written' ? '✍️ Written' : '🗣️ Oral'}
                              </span>
                            </td>
