...
export default function ClassesPage() {
  ...
  const handleDelete = async (id: string) => {
    if (confirm('Are you sure? This will delete the class, all students in it, and their schedule.')) {
    ...
    <div>
      ...
      {showForm && (
        <div className="bg-white rounded-xl shadow-sm p-5 mb-4 border-l-4 border-green-500">
          <h3 className="font-semibold text-gray-800 mb-3">New class</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <input
              placeholder="Class name (e.g. 3.b)"
              value={form.name}
