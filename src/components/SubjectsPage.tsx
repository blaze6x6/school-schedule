...
export default function SubjectsPage() {
  ...
  const handleDelete = async (id: string) => {
    if (confirm('Are you sure? This will also delete the schedule entries for this subject.')) {
    ...
    <div>
      ...
      {showForm && (
        <div className="bg-white rounded-xl shadow-sm p-5 mb-4 border-l-4 border-purple-500">
          <h3 className="font-semibold text-gray-800 mb-3">New subject</h3>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-3">
            ...
            />
            <input
              placeholder="Short name (e.g. MAT)"
