  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6 flex-wrap gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-800">Student notes</h1>
          <p className="text-gray-500 text-sm mt-1">Notes are visible to connected parents</p>
        </div>
      </div>
          ...
          <div className="bg-white rounded-xl shadow-sm overflow-hidden">
            {notesLoading ? (
              ...
              <div className="p-10 text-center text-gray-500">
                ...
                <p>There are no notes for this student.</p>
              </div>
            ) : (
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              <p className="text-sm text-gray-500 mb-1">
                                {format(parseISO(note.date), 'EEEE, d. MMMM yyyy', { locale: enUS })}
                              </p>
